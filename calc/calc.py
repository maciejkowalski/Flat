...
class MortgageCal:
    ...
    def get_balance(self):
        ...
        if self.installment_type is InstallmentType.decreasing_type:
            ...
            raise "Error::MortgageCal:Installment type not supported. Check parameters"
    ...
    def plot_simulation_graph(self):
        ...
        # figure 1
        fig1 = go.Figure(data=[go.Bar(name='capital', x=time, y=capital_part),
        ...
        # figure 2
        fig2 = go.Figure(data=[go.Bar(name='capital_sum', x=time, y=capital_sum),
...
if __name__ == '__main__':
    ...
    calc = MortgageCal(args.loan, args.bank_interest, args.wibor, args.loan_diuration, InstallmentType.from_str(args.installment_type))
